...
flag = 0
safe = 0
attack_duration = 999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999  # Set the attack duration in hours
pause_duration = 999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999   # Set the pause duration in hours
response_delay = 1   # Set the response delay in seconds
...
def usage():
    print('---------------------------------------------------')
    print('USAGE: python DDoS.py <url> [port] [attack_duration]')
...
if len(sys.argv) < 2:
    ...
    if sys.argv[1] == "help":
        ...
        if len(sys.argv) >= 3:
            port = int(sys.argv[2])
        if len(sys.argv) >= 4:
            attack_duration = float(sys.argv[3])
        if len(sys.argv) >= 5:
            if sys.argv[4] == "safe":
                set_safe()
        url = sys.argv[1]
